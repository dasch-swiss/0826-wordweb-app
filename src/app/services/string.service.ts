...
export class StringService {
    readonly strings = {
        text_help: "All texts are given in normalized spelling, taken from modern-spelling editions or normalized by hand from " +
            "scholarly or historical editions. The button \"Show historical spelling\" in your search results indicates that a passage " +
            "is also available in original spelling. Shakespeare's works are quoted from shakespeare.folger.edu",
